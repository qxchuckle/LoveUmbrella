...
var oLoding = document.getElementById("loding_box")[1];
...
// 				}, 7);
// 				if (window.location.href.indexOf('/zhuye/') == -1) {
...
btn1.addEventListener("click", function () {
	...
	oLoding.innerHTML = "<img src='loding.gif'>登录中";
...
btn2.addEventListener("click", function () {
	...
	oLoding.innerHTML = "<img src='loding.gif'>注册中";
